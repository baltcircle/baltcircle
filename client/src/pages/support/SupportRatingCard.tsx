 ...
 * обычный пузырь сообщения (не модальное окно) — появляется сразу после
 * системной заметки о закрытии сессии (см. SupportPage.tsx, событие
 * support_session_closed). Клик по звезде сразу отправляет оценку и
